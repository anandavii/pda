...
ggplot(data = nlsy_df, aes(x = industry_code)) +                                                  
  ...
  geom_text(stat = "count", aes(label = ..count..), vjust = -0.5) +                                                 
  labs(title = "Industry Code Distribution",                                                 
...
geom_bar() +                                                  
geom_text(stat = "count", aes(label = ..count..), vjust = -0.5) +                                                 
labs(title = "What is the Marital Status?",                                                 
x = "Marital Status",                                                 
y = "Count",
...
labs(title = "Total number of Incarcerations",                                                 
...
labs(title = "College Type Distribution",                                                 
x = "College Type",                                                 
y = "Count")+
  theme(axis.text.x = element_text(angle = 90, vjust = 0.5, hjust = 1))
```                                                 
...
geom_bar() +                                                 
geom_text(stat = "count", aes(label = ..count..), vjust = -0.5) +                                                 
labs(title = "IS Trustful or Distrustful",                                                 
x = "Trustfulness",                                                 
y = "Count")+
  theme_minimal()
```                                                 
...
ggplot(citizen_nlsy_df, aes(x = citizenship, y = total_income_2016, fill = gender)) +	
  ...
  labs(title = "Income vs Citizenship Distribution by Gender",		
       subtitle = "Including Topcoded Values",
    x = "Citizenship",																									
    y = "Total Income")	
```								
...
```{r}
# this is a new section by abhishek
```