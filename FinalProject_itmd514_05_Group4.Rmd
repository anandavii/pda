...
ggplot(data = nlsy_df, aes(x = reorder(birth_year,-table(birth_year)[birth_year], fill = birth_year)) +
  geom_bar() +
...
Out of the 95 variables we had only selected 15 so there could have been many Key confounders, few of them could be education level, occupation, and location, were not controlled for in the models. These factors likely influence income and could have lead to residual confounding in the analysis.
